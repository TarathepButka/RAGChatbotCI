    ...
    <nav className="bg-[#1b1b20] fixed w-full z-20 top-0 start-0 border-b border-gray-600 py-4">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
        ...
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-800 font-medium rounded-lg text- px-4 py-2 text-center cursor-pointer">Get started</button>
